...
public final class ProductServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.eswar.grpc.user.ProductRequest,
      com.eswar.grpc.user.ProductResponse> getGetProductMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetProduct",
      requestType = com.eswar.grpc.user.ProductRequest.class,
      responseType = com.eswar.grpc.user.ProductResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.eswar.grpc.user.ProductRequest,
      com.eswar.grpc.user.ProductResponse> getGetProductMethod() {
    io.grpc.MethodDescriptor<com.eswar.grpc.user.ProductRequest, com.eswar.grpc.user.ProductResponse> getGetProductMethod;
      ...
      synchronized (ProductServiceGrpc.class) {
        if ((getGetProductMethod = ProductServiceGrpc.getGetProductMethod) == null) {
          ProductServiceGrpc.getGetProductMethod = getGetProductMethod =
              io.grpc.MethodDescriptor.<com.eswar.grpc.user.ProductRequest, com.eswar.grpc.user.ProductResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetProduct"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.eswar.grpc.user.ProductRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.eswar.grpc.user.ProductResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getProduct(com.eswar.grpc.user.ProductRequest request,
  ...
  public static final class ProductServiceStub
    ...
    /**
     */
    public void getProduct(com.eswar.grpc.user.ProductRequest request,
        io.grpc.stub.StreamObserver<com.eswar.grpc.user.ProductResponse> responseObserver) {
  ...
  public static final class ProductServiceBlockingV2Stub
    ...
    /**
     */
    public com.eswar.grpc.user.ProductResponse getProduct(com.eswar.grpc.user.ProductRequest request) {
  ...
  public static final class ProductServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.eswar.grpc.user.ProductResponse> getProduct(
        com.eswar.grpc.user.ProductRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PRODUCT:
          serviceImpl.getProduct((com.eswar.grpc.user.ProductRequest) request,
              (io.grpc.stub.StreamObserver<com.eswar.grpc.user.ProductResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.eswar.grpc.user.ProductRequest,
              com.eswar.grpc.user.ProductResponse>(
  ...
  private static abstract class ProductServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.eswar.grpc.user.Product.getDescriptor();
    }
